...
The purpose of present document is to expound on this concept of multiple "entities" in relation to one another. For present purposes, we will use the word "network" to describe this inter-relationship web between entities linked together in a given field, environment or locus.


### How it might work:

```
Entity> query whois.in network
